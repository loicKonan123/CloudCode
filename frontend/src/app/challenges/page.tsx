    ...
    <div className="min-h-screen flex flex-col font-[var(--font-inter)] app-grid" style={{ backgroundColor: '#101b22', color: '#e2e8f0' }}>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-slate-800 bg-[#101b22] px-4 py-4 space-y-3">
          <button onClick={() => { router.push('/courses'); setMobileMenuOpen(false); }} className="block w-full text-left text-slate-400 hover:text-[#3caff6] text-sm font-medium py-2">
            Courses
          </button>
              ...
              <div className="flex flex-col lg:flex-row items-stretch">
                ...
                <div className="flex-1 p-6 lg:p-8 flex flex-col justify-center">
                  ...
                  <p className="text-slate-400 text-sm max-w-2xl mb-6">
                    Click to solve this challenge. Difficulty: {DifficultyNames[featured.difficulty]}.
                  </p>
